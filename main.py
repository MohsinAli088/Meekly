...
# BASIC CONFIG
# =========================
OWNER_IDS = [1504528054293237843, 1340627332116910140]
OWNER_ID = 1504528054293237843
DEV_ID = 1504528054293237843
DEVELOPER_IDS = [1504528054293237843, 1340627332116910140]
DEFAULT_PREFIX = "+"
...
INVITE_LINK = "https://discord.com/oauth2/authorize?client_id=1549065711333285898&scope=bot&permissions=8"
VOTE_LINK = "https://top.gg/bot/1549065711333285898/vote"
...
async def bot_setup_hook():
    print("🔄 [Startup] Auto-syncing emojis with Discord Developer Portal...")
    try:
        from emojis import sync_application_emojis
        await sync_application_emojis(bot)
    except Exception as e:
        print(f"⚠️ [Startup] Emoji auto-sync error: {e}")
...
@bot.event
async def on_ready():
    bot.invite_link = f"https://discord.com/oauth2/authorize?client_id={bot.user.id}&scope=bot&permissions=8"
    print("=" * 55)
...
async def main():
    ...
    async with bot:
        ...
        try:
            ...
            print("\n" + "⚠️ " * 25)
            print("CRITICAL: Privileged Gateway Intents are not enabled in Discord Developer Portal!")
            print("Please visit: https://discord.com/developers/applications/1549065711333285898/bot")
            print("Scroll down to 'Privileged Gateway Intents' and turn ON:")
            print("  1. [x] Server Members Intent")
            print("  2. [x] Message Content Intent")
            print("Then save changes and run the bot again.")
            print("⚠️ " * 25 + "\n")
