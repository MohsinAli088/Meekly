...
class Social(commands.Cog):
    ...
    async def initialize(self):
        ...
        self.check_task = asyncio.create_task(self.background_reminder_check())
    ...
    async def remind(self, ctx, time_input: str = None, *, message: str = None):
        ...
        asyncio.create_task(self.wait_and_remind(reminder_id, seconds, ctx.author.id, ctx.channel.id, message))
